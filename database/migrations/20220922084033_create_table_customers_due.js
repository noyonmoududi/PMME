exports.up = function(knex) {
    return knex.schema.createTable('customers_due', function (table) {
       ...
       table.specificType('due_amount', 'decimal(10,2)').notNullable();
       table.specificType('remaining_amount', 'decimal(10,2)').notNullable();
       table.string('installment_duration', 255).notNullable();
       table.specificType('installment_charge_percentage', 'decimal(10,2)').notNullable();
       table.specificType('installment_failed_charge_percentage', 'decimal(10,2)').notNullable();
